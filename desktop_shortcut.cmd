...
(
	...
	echo:oShortcut.IconLocation = "!this_path!\ahk.ico"
	echo:oShortcut.Save
) >!shortcut_script!
...
FOR /F "usebackq delims=" %%i in (`cscript "!this_path!\!desktop_script!"`) DO SET desktop_dir=%%i

del !desktop_script!

>nul move !link_name! !desktop_dir! /y
